...
namespace MicrositeAmey.Membership.Controllers.Surface
{
    ...
    public class ProfileSurfaceController : SurfaceController
    {
        ...
        public ActionResult RenderEditProfile()
        {
            ...
            return PartialView("_EditProfile", profileModel);
        }
        ...
        public ActionResult RenderViewProfile(string profileURL)
        {
        ...
        //Current member
        public ActionResult RenderViewOwnProfile()
        {
            //Get profileURLtoCheck
            //string profileURLtoCheck = Request.RequestContext.RouteData.Values["profileURLtoCheck"].ToString();
            ...
            var findMember = membershipService.GetById(memberShipHelper.GetCurrentMemberId());
